...
SurfaceProjection::usage = "SurfaceProjection[surf] yields a surface projection of the region within Pi/3 radians of the occipital pole, with V1 oriented along the positive x-axis. To alter the
