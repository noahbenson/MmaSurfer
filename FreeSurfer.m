...
Unprotect["FreeSurfer`*", "FreeSurfer`Private`*"];
ClearAll[ "FreeSurfer`*", "FreeSurfer`Private`*"];
...
DegreesOfFreedom::usage = "DegreesOfFreedom[mgh] yields the number of degrees of freedom of the given mgh object.";
...
OptionalData::usage = "OptionalData[mgh] yields a list of the optional data encoded in the file from which the mgh object was read.  OptionalData[mgh, name] yields the value of the optional datum, if stored in the file, with the given name, or None if no such datum was stored in the file.";
Header::usage = "Header[obj] yields the header data from certain FreeSurfer objects that have been imported.";
HeaderComment::usage = "HeaderComment[object] yields the header comment associated with reading in some objects.";
ImportedData::usage = "ImportedData[object] yields the raw data that was imported for object, if applicable.";
LookupTable::usage = "LookupTable[object] yields the color/label lookup table for an annotation object.";
...
MGHObjectFromData::usage = "MGHObjectFromData[data] yields an MGH object from the data (ie obtained via Import[... {\"MGH\", \"Data\"}]).";
...
$SubjectsDirs::usage = "$SubjectsDirs is a list of potential FreeSurfer subjects directories; it is obtained at runtime from the $SUBJECTS_DIR environment variable as well as by scanning common FreeSurfer paths.";
$Subjects::usage = "$Subjects is a list of potential FreeSurfer subjects (named by their directories). If you wish to add an arbitrary subject to FreeSurfer, use AddSubject.";
...
Subject::usage = "Subject[directory] represents a FreeSurfer subject whose data is stored in the directory named by directory.";
...
SubjectSymSurface::usage = "SubjectSymSurface[sub, hemi] yields the subject's cortical surface registered to the spherical fsaverage_sym hemisphere for subject sub's specified hemishere.";

(* Surface Field Functions *)
SubjectJacobian::usage = "SubjectJacobian[sub, hemi] yields the Jacobian field for the subejct sub's given hemisphere.";
SubjectCurvature::usage = "SubjectCurvature[sub, hemi] yields the curvature for subject sub's given hemisphere.";
SubjectSulci::usage = "SubjectSulci[sub, hemi] yields the sulcal depth for subject sub's given hemisphere.";
SubjectThickness::usage = "SubjectThickness[sub, hemi] yields the thickness of each vertex for subject sub's given hemisphere.";
SubjectVertexArea::usage = "SubjectVertexArea[sub, hemi] yields the area of each vertex for subject sub's given hemisphere (?h.mid.area).";
SubjectVertexAreaPial::usage = "SubjectVertexAreaPial[sub, hemi] yields the pial area of each vertex for subject sub's given hemisphere (?h.area.pial).";
SubjectVertexAreaWhite::usage = "SubjectVertexAreaWhite[sub, hemi] yields the white matter area of each vertex for subject sub's given hemisphere (?h.area.white).";
SubjectVertexVolume::usage = "SubjectVertexVolume[sub, hemi] yields the volume of each vertex for subject sub's given hemisphere";
SubjectParcellation::usage = "SubjectParcellation[sub, hemi] yields the 2009 cortical surface parcellation for subject sub's given hemisphere.";
SubjectParcellation2009::usage = "SubjectParcellation[sub, hemi] yields the 2009 cortical surface parcellation for subject sub's given hemisphere.";
SubjectParcellation2005::usage = "SubjectParcellation[sub, hemi] yields the 2005 cortical surface parcellation for subject sub's given hemisphere.";
...
FSAverageOriginalSurface::usage = "FSAverageOriginalSurface[hemi] yields the fsaverage subject's original surface.";
FSAveragePialSurface::usage = "FSAveragePialSurface[hemi] yields the fsaverage subject's pial surface.";
FSAverageInflatedSurface::usage = "FSAverageInflatedSurface[hemi] yields the fsaverage subject's inflated surface.";
FSAverageSphereSurface::usage = "FSAverageSphereSurface[hemi] yields the fsaverage subject's spherical surface.";
...
FSAverageThickness::usage = "FSAverageThickness[hemi] yields the fsaverage subject's cortical thickness.";
FSAverageRegisteredCurvature::usage = "FSAverageRegisteredCurvature[hemi] yields the fsaverage subject's average curvature.";
FSAverageVertexArea::usage = "FSAverageVertexArea[hemi] yields the fsaverage subject's vertex areas (mid.area).";
FSAverageVertexAreaPial::usage = "FSAverageVertexAreaPial[hemi] yields the fsaverage subject's vertex areas (area.pial)";
FSAverageVertexAreaWhite::usage = "FSAverageVertexAreaWhite[hemi] yields the fsaverage subject's white matter vertex areas (area.white).";
FSAverageVolume::usage = "FSAverageVolume[hemi] yields the fsaverage subject's vertex volumes.";
FSAverageParcellation::usage = "FSAverageParcellation[hemi] yields the fsaverage subject's region parcellations (2009).";
FSAverageParcellation2009::usage = "FSAverageParcellation2009[hemi] yields the fsaverage subject's region parcellations (2009).";
FSAverageParcellation2005::usage = "FSAverageParcellation2005[hemi] yields the fsaverage subject's region parcellations (2005).";
...
FSAverageSymOriginalSurface::usage = "FSAverageSymOriginalSurface yields the fsaverage_sym subject's original surface.";
FSAverageSymPialSurface::usage = "FSAverageSymPialSurface yields the fsaverage_sym subject's pial surface.";
FSAverageSymInflatedSurface::usage = "FSAverageSymInflatedSurface yields the fsaverage_sym subject's inflated surface.";
FSAverageSymSphereSurface::usage = "FSAverageSymSphereSurface yields the fsaverage_sym subject's spherical surface.";
FSAverageSymInvOriginalSurface::usage = "FSAverageSymInvOriginalSurface yields the fsaverage_sym subject's original surface, but inverted along the L-R axis (to appear like an RH).";
FSAverageSymInvPialSurface::usage = "FSAverageSymInvPialSurface yields the fsaverage_sym subject's pial surface, but inverted along the L-R axis (to appear like an RH).";
FSAverageSymInvInflatedSurface::usage = "FSAverageSymInvInflatedSurface yields the fsaverage_sym subject's inflated surface, but inverted along the L-R axis (to appear like an RH).";
FSAverageSymInvSphereSurface::usage = "FSAverageSymInvSphereSurface yields the fsaverage_sym subject's spherical surface, but inverted along the L-R axis (to appear like an RH).";
FSAverageSymCurvature::usage = "FSAverageSymCurvature yields the fsaverage_sym subject's curvature.";
FSAverageSymSulci::usage = "FSAverageSymSulci yields the fsaverage_sym subject's sulcal depth.";
FSAverageSymThickness::usage = "FSAverageSymThickness yields the fsaverage_sym subject's cortical thickness.";
FSAverageSymRegisteredCurvature::usage = "FSAverageSymRegisteredCurvature yields the fsaverage_sym subject's average curvature.";
FSAverageSymVertexArea::usage = "FSAverageSymVertexArea yields the fsaverage_sym subject's vertex areas (mid.area).";
FSAverageSymVertexAreaPial::usage = "FSAverageSymVertexAreaPial yields the fsaverage_sym subject's vertex areas (area.pial)";
FSAverageSymVertexAreaWhite::usage = "FSAverageSymVertexAreaWhite yields the fsaverage_sym subject's white matter vertex areas (area.white).";
FSAverageSymVolume::usage = "FSAverageSymVolume yields the fsaverage_sym subject's vertex volumes.";
FSAverageSymParcellation::usage = "FSAverageSymParcellation yields the fsaverage_sym subject's region parcellations (2009).";
FSAverageSymParcellation2009::usage = "FSAverageSymParcellation2009 yields the fsaverage_sym subject's region parcellations (2009).";
FSAverageSymParcellation2005::usage = "FSAverageSymParcellation2005 yields the fsaverage_sym subject's region parcellations (2005).";
...
FSAverageOP::usage = "FSAverageOP[hemi] is the (lazily-evaluated) index of the vertex in the occipital cortex (spherical hemisphere) that corresponds roughly to the tip of the occipital pole in the fsaverage.";
FSAveragePialOP::usage = "FSAveragePialOP[hemi] yields the vertex coordinate (not the index) of the occipital pole in the given hemisphere hemi of the fsaverage brain's pial surface.";
FSAverageInflatedOP::usage = "FSAverageInflatedOP[hemi] yields the vertex coordinate (not the index) of the occipital pole in the given hemisphere hemi of the fsaverage brain's inflated surface.";
FSAverageSphereOP::usage = "FSAverageSphereOP[hemi] yields the vertex coordinate (not the index) of  the occipital pole in the given hemisphere hemi of the fsaverage brain's spherical surface.";
FSAverageSymOP::usage = "FSAverageSymOP is the (lazily-evaluated) index of the vertex in the occipital cortex that corresponds roughly to the tip of the occipital pole in the fsaverage_sym brain.";
FSAverageSymPialOP::usage = "FSAverageSymPialOP[hemi] yields the vertex coordinate (not the index) of the occipital pole in the given hemisphere hemi of the fsaverage brain's pial surface.";
FSAverageSymInflatedOP::usage = "FSAverageSymInflatedOP[hemi] yields the vertex coordinate (not the index) of the occipital pole in the given hemisphere hemi of the fsaverage brain's inflated surface.";
FSAverageSymSphereOP::usage = "FSAverageSymSphereOP[hemi] yields the vertex coordinate (not the index) of the occipital pole in the given hemisphere hemi of the fsaverage brain's spherical surface.";

SubjectOP::usage = "SubjectOP[sub, hemi] yields the vertex index of the subject sub's occipital pole in the given hemisphere hemi.";
SubjectPialOP::usage = "SubjectPialOP[sub, hemi] yields the vertex coordinate (not the index) of the occipital pole in the given subject sub's given pial hemisphere hemi.";
SubjectInflatedOP::usage = "SubjectInflatedOP[sub, hemi] yields the vertex coordinate (not the index) of the occipital pole in the given subject sub's given inflated hemisphere hemi.";
SubjectSphereOP::usage = "SubjectSphereOP[sub, hemi] yields the vertex coordinate (not the index) of the occipital pole in the given subject sub's given spherical hemisphere hemi.";
SubjectRegisteredOP::usage = "SubjectRegisteredOP[sub, hemi] yields the vertex coordinate (not the index) of the occipital pole in the given subject sub's given registered spherical hemisphere hemi.";
SubjectSymOP::usage = "SubjectSymOP[sub, hemi] yields the vertex coordinate (not the index) of the occipital pole in the given subject sub's given sym-registered spherical hemisphere hemi.";
...
FSAverageSymSphereSurface := Check[
  ...
  $Failed];
FSAverageSymInvOriginalSurface := With[
  {res = Check[
    With[
